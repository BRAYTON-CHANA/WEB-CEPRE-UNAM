          ...
          <div className="space-y-16">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Link to="/modules/test-database" className="block">
                  <div className="card p-6 hover:shadow-lg transition-shadow cursor-pointer">
                    <div className="mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Test Database</h3>
                      <p className="text-gray-600 mb-4">
                        Página de prueba para testing de conexión Supabase y funcionalidades CRUD.
                      </p>
                ...
                <Link to="/modules/test-multilevelTable" className="block">
                  <div className="card p-6 hover:shadow-lg transition-shadow cursor-pointer">
                    <div className="mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Test MultiLevel Table</h3>
                      <p className="text-gray-600 mb-4">
                        Prueba del componente TableMultiLevel con agrupación multinivel.
                      </p>
                      <span className="text-xs bg-teal-100 text-teal-600 px-2 py-1 rounded">MultiLevel</span>
                    </div>
                  </div>
                </Link>
              </div>
