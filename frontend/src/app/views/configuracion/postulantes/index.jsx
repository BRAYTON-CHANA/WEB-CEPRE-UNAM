...
/**
 * Postulantes — CRUD 2 niveles con selector de período
 * Selector: Período (antes de cargar datos)
 * Nivel 1: Grupo (con conteo de postulantes + botón "Añadir Postulante")
 * Nivel 2: Postulante (CRUD completo)
 */
function PostulantesConfig() {
  ...
  // ==========================================
  // 4. ESTADOS PARA CREAR POSTULANTE DESDE GRUPO
  // ==========================================
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Seleccione un período para ver los grupos y sus postulantes
          </p>
        </div>
        ...
        {selectedPeriodo ? (
          ...
          <div className="p-12 bg-white rounded-xl border border-gray-200 shadow-sm text-center">
            ...
            <p className="mt-1 text-sm text-gray-400">Elija un período académico para ver los grupos y sus postulantes.</p>
          </div>
        )}
      </div>
    </LayoutWithSidebar>
