...
import { headerProps, getHeaderActions } from '@/features/feriados/config/headerConfig';
import { useFeriados } from '@/features/feriados/hooks/useFeriados';

/**
 * Configuración de FERIADOS
 * CRUD simple: lista feriados (desde VW_FERIADOS) con crear/editar/eliminar sobre FERIADOS.
 */
function FeriadosConfig() {
  const {
    tableRecords,
    loading,
    error,
          ...
          return (
            <div className="px-8 py-8 space-y-8 pb-12">
              <CrudHeader
                ...
                actions={getHeaderActions(feriadosCrud)}
              />
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-x-auto">
                  <TableMultiLevelEditable
                    ...
                    formatToastMessage={(recordId, field, newValue, primaryKey, rowData, header) =>
                      `Feriado ${rowData?.FECHA || ''}: ${header?.label || field} → ${newValue}`
                    }
