 ...
 * 
 * Props:
 * - name: Nombre del icono (plus, edit, trash, eye, mail, download, more-vertical, user, users, file-text)
...
const Icon = ({ 
  ...
  const icons = {
    ...
    building: (
      <>
        <path d="M3 21h18M5 21V7l8-4v18M19 21V11l-4-2M9 9h1M9 13h1M9 17h1" strokeLinecap="round" strokeLinejoin="round" />
      </>
    ),
    'file-text': (
