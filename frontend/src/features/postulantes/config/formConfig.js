...
export const postulanteFormFields = [
  ...
  {
    name: 'ID_SEDE_VACANTE',
    type: 'reference-select',
    label: 'Sede de Vacante',
    required: true,
  ...
  },
  {
    ...
    referenceFilters: [
      ...
      { field: 'ID_SEDE', op: '=', value: '{ID_SEDE_VACANTE}' }
    ],
    blocked: {
      and: [
        { field: 'ID_PERIODO', op: '=', value: '' },
        { field: 'ID_SEDE_VACANTE', op: '=', value: '' }
      ]
    },
...
export const postulanteValidation = {
  ...
  ID_SEDE_VACANTE: {
    required: { value: true, message: 'La sede de vacante es obligatoria' }
  },
  NOMBRES: {
