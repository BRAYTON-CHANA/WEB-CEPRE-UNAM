...
const CepreSidebar = () => {
  ...
  const { esDocente, esAdmin, puedeVerAsistenciasViejo, puedeVerAsistenciasNuevo } = getRoleFlags(user, activeRole);
  ...
  const menuItems = [
    ...
    },
    {
      id: 'sesiones',
      name: 'Sesiones',
      description: 'Todas las sesiones del período',
      icon: <TableIcon />,
      href: '/sesiones',
      active: location.pathname === '/sesiones',
      hidden: !esAdmin
    }
  ];
