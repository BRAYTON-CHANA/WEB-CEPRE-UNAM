...
import { formatFecha, formatHora, formatFechaHora } from '../../../grupos/utils';
...
export function TablaSesiones({ sesiones, onMarcar, onMarcarEstudiantes, onVaciar, vaciando, nombreCurso }) {
  if (!sesiones.length) {
    return (
