...
/**
 * SmtpPanel — página de gestión de cuentas SMTP.
 * Usa service custom (smtpService) y form custom (SmtpForm).
 */
function SmtpPanel() {
  const {
  ...
  return (
    <ConfigLayout>
      ...
      >
        <div className="p-6">
          <SmtpForm mode="create" onSuccess={handleSuccess} onError={handleError} />
        </div>
      </Modal>
