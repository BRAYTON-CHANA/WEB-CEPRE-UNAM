 ...
 */
export async function createEmail({ tipo, idUsuarios = [], to, cc = [], bcc = [], subject, html, text, attachments = [], creadoPor, idCreador = null, prioridad = 'normal', fechaProgramada = null, metadatos = {}, idCuenta = null, forceSend = false }) {
  ...
  const insertData = {
    ...
    ID_CUENTA_SMTP: finalMetadatos.id_cuenta || null,
 ...
 */
export async function sendEmailNow(idCorreo, correo = null, tipo = null, idEnviador = null) {
  await DatabaseManager.connect();
 ...
 */
export async function createMassEmail({ tipo, viewName, idField = 'ID_USUARIO', recipients, cc = [], bcc = [], subject, html, text, attachments = [], creadoPor, idCreador = null, prioridad = 'normal', fechaProgramada = null, metadatos = {}, idCuenta = null, remitente }) {
  await DatabaseManager.connect();
