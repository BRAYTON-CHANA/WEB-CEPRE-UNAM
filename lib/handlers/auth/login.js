...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await DatabaseManager.query(
      'SELECT u."ID_USUARIO", u."DNI", u."NOMBRES", u."APELLIDO_PATERNO", u."APELLIDO_MATERNO", u."PASSWORD_HASH", u."ID_ROLES", u."ACTIVO", u."REQUIERE_CAMBIO_PASSWORD" FROM "USUARIOS" u WHERE u."DNI" = $1 AND u."ACTIVO" = TRUE',
      dni
    );
